						...
						<div class="panel panel-default empresa">
						 	<div class="panel-heading">¡Bienvenido <? echo $_SESSION['nombreUsuario'] ?>!</div>
						  	<div class="panel-body">
								...
								<br>
									<div class="col-md-12">
										<a id="cerrarSesion" class="col-md-5 col-md-offset-1 btn btn-success" style="margin-top: 5px;">Cerrar Sesión</a>
										<a class="col-md-5 col-md-offset-1 btn btn-info" href="perfil" style="margin-top: 5px;">Administrar Sitio WEB</a>
						  			</div>
						  	</div>
						</div>
					<?php
